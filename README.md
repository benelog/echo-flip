...
영어 단어·문장·숙어를 카드로 뒤집으며 외우는 학습 앱.
...
- 카드(앞: 영어 / 뒤: 뜻·예문·발음기호) + 덱 관리, 태그
- 학습: 카드 뒤집기 → 스스로 맞음/틀림 판정 → 덱 소화 후 틀린 카드 재도전 라운드
...
- CSV 가져오기/내보내기 (`front,back,type,tags,phonetic,example`, 태그는 `|` 구분)
