...
const chapters = [
  ...
  { route: 'part1/gin', title: '7장 Gin으로 만드는 HTTP API' },
  { route: 'part1/html-css', title: '8장 HTML과 CSS: 화면을 이루는 문서와 스타일' },
  { route: 'part1/go-templates', title: '9장 html/template으로 만드는 화면' },
  { route: 'part1/htmx', title: '10장 htmx: 자바스크립트 없이 만드는 동적 화면' },
  { route: 'part1/claude-code', title: '11장 Claude Code: AI 에이전트와 개발하기' },
  { route: 'part1/agents-hooks', title: '12장 서브에이전트와 훅으로 만드는 품질 게이트' },
