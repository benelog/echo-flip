...
::: info 용어 · 간격 반복(Spaced Repetition·SRS)
...
::: info 용어 · API(Application Programming Interface)
...
::: info 용어 · PWA(Progressive Web App)
...
이 책에는 곳곳에 "용어 · "로 시작하는 상자가 있는데, 개발이 처음인 독자를 위해 낯선 용어를 두어 문장으로 풀어 둔 것이다.
