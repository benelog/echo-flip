...
::: info 용어 · 관리형 서비스(Managed Service)
...
인감과 인감증명서에 빗댈 수 있다 — 인감은 주인만 찍을 수 있지만, 인감증명서(공개키)를 가진 사람은 누구나 그 도장이 진짜인지 대조할 수 있다.
...
::: info 용어 · 프리페어드 스테이트먼트(Prepared Statement)
