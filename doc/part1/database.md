...
::: info 용어 · 테이블·행·열(Table·Row·Column)
...
::: info 용어 · 기본 키와 외래 키(Primary Key·Foreign Key)
...
::: info 용어 · 행 수준 보안(RLS, Row Level Security)
