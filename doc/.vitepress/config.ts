    ...
    sidebar: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: '8장 React 기초: 컴포넌트, 상태, 훅', link: '/part1/react' },
          { text: '9장 React 실전과 Next.js: 전역 상태와 정적 export', link: '/part1/react-next' },
          { text: '10장 데이터베이스 기초: 테이블, SQL, 인덱스', link: '/part1/database-basics' },
          { text: '11장 PostgreSQL 데이터베이스 설계', link: '/part1/database' },
        ],
      },
      {
        text: '2부 에이전트와 인프라로 앱 만들고 운영하기',
        items: [
          { text: '12장 Claude Code: AI 에이전트와 개발하기', link: '/part2/claude-code' },
          { text: '13장 서브에이전트와 훅으로 만드는 품질 게이트', link: '/part2/agents-hooks' },
          { text: '14장 Vercel: 한 플랫폼에 모두 배포하기', link: '/part2/vercel' },
          { text: '15장 Supabase: 인증과 데이터베이스', link: '/part2/supabase' },
        ],
      },
    ],
    outline: false,
