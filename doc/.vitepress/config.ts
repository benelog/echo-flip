    ...
    sidebar: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: '3장 PostgreSQL 데이터베이스 설계', link: '/part1/database' },
      ...
      },
      {
        ...
        items: [
          ...
          { text: '14장 로컬 개발 환경: direnv와 VS Code', link: '/part2/local-dev' },
          ...
          { text: '18장 Supabase 데이터베이스 연결: pgx와 트랜잭션 풀러', link: '/part2/supabase-db' },
